...
function builder(options) {
  ...
  if (!options.network) {
    options.network = btcLib.Networks.defaultNetwork;
  }

  options.Block = options.Block || btcLib.Block;
  options.BlockHeader = options.BlockHeader || btcLib.BlockHeader;
  options.Transaction = options.Transaction || btcLib.Transaction;
  options.MerkleBlock = options.MerkleBlock || btcLib.MerkleBlock;
