...
function builder(options) {
  ...
  if (!options.network) {
    options.network = btccore.Networks.defaultNetwork;
  }

  options.Block = options.Block || btccore.Block;
  options.BlockHeader = options.BlockHeader || btccore.BlockHeader;
  options.Transaction = options.Transaction || btccore.Transaction;
  options.MerkleBlock = options.MerkleBlock || btccore.MerkleBlock;
